...
| ------------------------------- | --------------------------------------------------------------------------- |
| Usuaris                         | Aina Ciurans, Dídac Gassó, Laia Macias, Talia Costas...                     |
| Grups                           | Direcció, Administració, Informàtica, Producció musical...                  |
| Equips                          | Ordinadors dels treballadors, portàtils, equips de producció...             |
| Servidors                       | Servidor de fitxers, servidor web, servidor de còpies de seguretat...       |
| Comptes d'aplicacions o serveis | Compte del servei de còpies de seguretat, compte d'una aplicació interna... |

Hi afegiries algun altre tipus d'objecte?

Sí, es podrien afegir impressores i recursos compartits, perquè també poden necessitar una gestió centralitzada.
...
Serveix principalment per organitzar els objectes del directori, com usuaris, ordinadors o servidors.

**Grup:**

Serveix per agrupar persones o comptes i poder assignar-los permisos o privilegis conjuntament.
...
Un servei de directori concret ni un sinònim d’Active Directory.
